			...
			<div class="navbar-collapse collapse">							
				<div class="menu">
					<ul class="nav nav-tabs" role="tablist">
						<li role="presentation"><a href="{{url('')}}" class="{{Request::is('/') ? "active" : "" }}">Home</a></li>
						<li role="presentation" class="dropdown">
							<a class="dropdown-toggle {{Request::is('tentangkami/sejarah','tentangkami/visi-misi','tentangkami/struktur-organisasi','tentangkami/sarana-dan-prasarana') ? "active" : "" }}" data-toggle="dropdown" href="#">Tentang Kami <span class="caret"></span></a>
						...
						<li role="presentation" class="dropdown">
							...
							<ul class="dropdown-menu" role="tablist">
								<li role="presentation"><a href="{{url('program-kursus')}}">Program Kursus</a></li>
